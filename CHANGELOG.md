...
All notable Agent-C changes are recorded here. Each entry records the commit that
introduced it; entries may use `pending` until the commit ID exists, then a later
changelog maintenance commit backfills the hash.
